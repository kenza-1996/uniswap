...
const {postGroupes, postMembres, getGroup, putGroup, deleteGroup, postPublication, getAllPublications,getPublication,
    commentOnPublication,likePublication, unlikePublication, deletePublication} = require('./clubs/clubs');   
...
app.post('/createClubs' ,FBAuth, postGroupes);
app.post('/createmembres' ,FBAuth, postMembres);
...
//app.post('/followereq',  SendFollowRequestGroup);
//app.post('/followe',  acceptFollowRequestGroup);
